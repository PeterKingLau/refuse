export default {
  ...
  setting: {
    ...
    footer: 'Footer',
    uniqueOpened: 'Accordion menu',
    tagsViewIcon: 'Tags view icon',
    dynamicRouter: 'Dynamic routes',
    reExperienced: 'Please log out and try again',
  ...
  login: {
    ...
    message: 'Waste classification system',
    username: 'Username',
    password: 'Password',
    register: 'Register',
  ...
  router: {
    ...
    cManagent: 'Sub-operator',
    power: 'Permission management',
    ...
    devicePut: 'Device Distribution',
    rule: 'Operating Rules',
    memberModel: 'Member management',
    member: 'Member',
    ...
    order: 'Record query',
    orderList: 'Drop-off records',
    log: 'Log records',
    sysLog: 'Operation log',
    loginLog: 'Login Log',
    point: 'Points records',
    clearRecord: 'Collection records',
    video: 'Media management',
    medium: 'Android media',
    warningList: 'Device alarms',
    apkPackage: 'Firmware upgrade',
    DataAnalysis: 'Data Analysis',
    pointAnalysis: 'Point Analysis',
    pointsSetting: 'Withdrawal settings',
    cashList: 'Cash withdrawal review',
  ...
  g2ChartDemo: {
    g2Chart: 'G2Chart',
    g2ChartDes: 'Based on the secondary packaging components of G2, the width is adaptive. The corresponding chart can be displayed by passing in the options and height attributes.'
  },
  countToDemo: {
    countTo: 'CountTo',
  ...
  richText: {
    richText: 'Rich text',
    richTextDes: 'Secondary packaging based on Tiptap'
  },
  dialogDemo: {
    dialog: 'Dialog',
